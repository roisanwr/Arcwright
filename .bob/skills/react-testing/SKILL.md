...
- [`references/edge-case-checklist.md`](references/edge-case-checklist.md) — compact 5-point edge case checklist adapted from AionUi. Covers null/undefined, empty inputs, dependency errors, boundary values, and async edge cases.
